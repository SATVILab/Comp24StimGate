...
This pipeline is computationally intensive due to the nested loops over simulations and tail-gate tolerance values. Outputs are cached in `_tmp/targets` for reuse.
